...
export default function ComponentsIndexPage() {
  const categories = [
    ...
    { name: "Form", description: "Inputs, selects, checkboxes, and form controls", count: 16, href: "/components/form", icon: "📝", status: "coming" },
    { name: "Data Display", description: "Tables, badges, avatars, and data visualization", count: 17, href: "/components/data-display", icon: "📊", status: "coming" },
    ...
    { name: "Layout", description: "Navbar, footer, sidebar, and page layouts", count: 11, href: "/components/layout", icon: "🏗️", status: "coming" },
    { name: "Content", description: "Prose, markdown, and code blocks", count: 3, href: "/components/content", icon: "📄", status: "ready" },
    { name: "Marketing", description: "Hero, features, testimonials, and landing sections", count: 13, href: "/components/marketing", icon: "🎯", status: "coming" },
    { name: "E-commerce", description: "Products, cart, checkout, and shopping components", count: 11, href: "/components/ecommerce", icon: "🛒", status: "coming" },
    { name: "SaaS", description: "Dashboard, metrics, pricing, and SaaS patterns", count: 15, href: "/components/saas", icon: "💼", status: "coming" },
    { name: "System", description: "Error pages, theme switcher, and system utilities", count: 11, href: "/components/system", icon: "⚙️", status: "coming" },
