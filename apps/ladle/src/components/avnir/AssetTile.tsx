...
const typeConfig: Record<AssetType, {
      ...
      >
        ...
        <div className="relative mb-3">
          {thumbnail ? (
            ...
            <div className="aspect-video rounded-[var(--radius-sm)] bg-white/5 flex items-center justify-center">
              <div className={cx("text-2xl", typeInfo.color)}>
                {typeInfo.icon}
              </div>
            </div>
          )}
          ...
          <div className="absolute top-2 right-2">
            <Badge className={cx("text-xs", statusInfo.color)}>
              {statusInfo.label}
            </Badge>
          </div>
        ...
        <div className="space-y-2">
          <div className="flex items-start justify-between">
            ...
            <div className={cx("flex-shrink-0 text-xs", typeInfo.color)}>
              {typeInfo.label}
            </div>
          </div>
