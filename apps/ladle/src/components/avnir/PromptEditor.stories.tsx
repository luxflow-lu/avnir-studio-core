...
const mockPresets = [
  {
    ...
    prompt: "Crée un beat trap moderne avec des 808 puissants, des hi-hats rapides et une mélodie sombre. Style Atlanta, tempo 140 BPM.",
    category: "Beats",
  ...
  },
  {
    ...
    prompt: "Génère une ligne vocale R&B smooth avec des harmonies riches, style années 90, ambiance romantique et sensuelle.",
    category: "Vocals",
  ...
  },
  {
    id: "3",
    name: "Ambiance Lo-Fi",
    prompt: "Crée une ambiance lo-fi chill avec des samples vinyle, des drums doux et une mélodie nostalgique au piano.",
    category: "Ambiance",
  ...
  },
  {
    ...
    prompt: "Compose un hook accrocheur pour un titre commercial, mélodie simple et répétitive, facile à retenir.",
...
export const WithContent = () => {
  const [prompt, setPrompt] = useState("Crée un beat trap lourd avec des 808 qui claquent, des hi-hats rapides en double-time et une mélodie sombre au synthé. Le tout dans un style Atlanta moderne, tempo 140 BPM, avec des breaks pour laisser respirer le flow.");
