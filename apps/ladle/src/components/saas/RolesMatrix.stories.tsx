...
const mockPermissions = [
  ...
  },
  {
    id: "read_files",
    name: "View Files",
    description: "Can view files in projects",
    category: "Files",
  },
  {
    id: "write_files",
    name: "Edit Files",
    description: "Can edit and upload files",
    category: "Files",
  },
  {
    id: "manage_users",
  ...
  },
  {
    id: "manage_billing",
    name: "Manage Billing",
    description: "Can view and edit billing",
    category: "Administration",
  },
];
...
export const Readonly = () => (
  <div className="bg-[var(--bg)] text-white p-6">
    <RolesMatrix roles={mockRoles} permissions={mockPermissions} readonly />
  </div>
);
