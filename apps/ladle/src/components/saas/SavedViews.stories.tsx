...
const mockViews = [
  {
    ...
    filters: { status: "active", type: "customer" } as Record<string, any>,
    isDefault: true,
  ...
  },
  {
    ...
    filters: { amount: ">1000", status: "completed" } as Record<string, any>,
  ...
  },
  {
    id: "3",
    name: "Recent Signups",
    filters: { created: "last_7_days", status: "pending" } as Record<string, any>,
