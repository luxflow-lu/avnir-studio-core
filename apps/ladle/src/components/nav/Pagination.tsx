...
export const Pagination = React.forwardRef<HTMLDivElement, PaginationProps>(
  ({ 
    ...
    const buttonClass = "px-3 py-2 text-sm font-medium rounded-[var(--radius-sm)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--brand)] focus:ring-offset-2 focus:ring-offset-[var(--bg)]";
