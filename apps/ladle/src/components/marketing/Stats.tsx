...
export type StatsProps = { title?: string; items: Stat[]; columns?: 2 | 3 | 4; className?: string } & React.HTMLAttributes<HTMLElement>;
...
export const Stats = React.forwardRef<HTMLElement, StatsProps>(({ title, items, columns = 4, className, ...props }, ref) => {
  return (
