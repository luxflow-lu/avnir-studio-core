...
export type LogoCloudProps = { title?: string; subtitle?: string; logos: Logo[]; className?: string } & React.HTMLAttributes<HTMLElement>;

export const LogoCloud = React.forwardRef<HTMLElement, LogoCloudProps>(({ title, subtitle, logos, className, ...props }, ref) => {
  return (
