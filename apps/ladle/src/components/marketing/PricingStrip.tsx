...
export type PricingStripProps = { title?: string; subtitle?: string; cta: React.ReactNode; className?: string } & React.HTMLAttributes<HTMLElement>;

export const PricingStrip = React.forwardRef<HTMLElement, PricingStripProps>(({ title, subtitle, cta, className, ...props }, ref) => {
  return (
