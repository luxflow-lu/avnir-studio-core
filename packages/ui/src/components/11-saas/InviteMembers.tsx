...
import { Select } from "../02-form/Select";
    ...
    return (
      <div ref={ref} className={cx("card", className)} {...props}>
        <div className="card-header">
          <div>
            <h3 className="card-title">Invite Team Members</h3>
            <p className="card-description">Add people to your workspace and assign roles</p>
          </div>
          <Badge>
        ...
        <div className="card-content">
          <div className="invite-members-form">
            {invites.map((invite, index) => (
              <div key={index} className="invite-members-input-group">
                <Input
                  type="email"
